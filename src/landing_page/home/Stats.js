        ...
        <div className='container '>
            <div className='row '>
                ...
                <div className='col-6  p-5'>
                    <img src='media/images/ecosystem.png' alt='eco-system' style={{width:"90%"}} />
                
                    <div className='text-center'>
                        <a href='jk' className='mx-5' style={{textDecoration:"none"}} >Explore our products <i class="fa-solid fa-arrow-right" ></i></a>
                        <a href='k'  style={{textDecoration:"none"}} >Try Kite demo <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
